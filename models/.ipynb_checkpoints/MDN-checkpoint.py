...
class SurvivalMDN(nn.Module):
    ...
    def __init__(self,backbone=None,input_size=384,hidden_size=256,K=10,param_share = ['mu','sigma'],dropout=0.1,**kwargs):
        ...
        # print('param share',self.param_share)
    ...
    def cdf(self,params,times):
        ...
        if len(times.shape)==1:
            ...
            # print('bakriiiiiiiiiiiiiiiiiiiiiiiii')
    ...
    def forward(self,x,**kargs):
        ...
        if isinstance(h,dict):
            ...
            subloss = None
        h = self.mlp(h)
        # print('h shape after mlp',h.shape)
        i = 0
        params = {}
    ...
    def train_step(self,x,t,c,constant_dict):
        ...
        # print('params',params)
        # print('shape of params',params['w'].shape)
        # print('shape of params',params['mu'].shape)
        # print('shape of params',params['sigma'].shape)
